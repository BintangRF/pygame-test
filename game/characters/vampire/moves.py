"""Vampire move list: Shadow Spin, Blood Bolt, Blood Curse, Bat Swarm,
...
def make_vampire_abilities():
    return {
        ...
        "skills": [
            ...
            Ability("Bat Swarm", "skill", "swarm", 9000, 1.3, tag="swarm"),
            Ability("Blood Pool", "skill", "cast", 3000, 0.0, tag="blood_pool"),
            Ability("Crimson Doppelganger", "skill", "cast", 16500, 0.0, tag="clone"),
        ],
