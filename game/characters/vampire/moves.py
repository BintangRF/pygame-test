...
def make_vampire_abilities():
    return {
        ...
        "skills": [
            Ability("Blood Bolt", "skill", "bolt", 6500, 1.2, heal_ratio=0.35, tag="blood_bolt"),
            Ability("Blood Hex", "skill", "bolt", 10500, 0.0, tag="curse"),
            Ability("Bat Swarm", "skill", "swarm", 8000, 1.2, tag="swarm"),
            Ability("Blood Pool", "skill", "cast", 5000, 0.0, tag="blood_pool"),
