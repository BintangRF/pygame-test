...
def make_johnny_abilities():
    return {
        ...
        "basic": Ability("Nail Bullet", "basic", "bolt", 0.1, 1, tag="nail_bullet",
        ...
        "skills": [
            ...
            Ability("Tusk Act 2", "skill", "homing_bolt", 1.5, 1, tag="tusk_act2", ignore_clone=True),
            ...
            Ability("Tusk Act 3", "skill", "ricochet", 3, 1.8, tag="tusk_act3",
                    moves_while_active=True),
        ],
        ...
        "ultimate": Ability("Tusk Act 4", "ultimate", "homing_bolt", 6, 3, big=True, tag="tusk_act4",
                            ignore_clone=True),
    }
