...
def make_phantom_lancer_abilities():
    return {
        "basic": Ability("Spear Slash", "basic", "slash", 1, 1, melee_range=100),
        "skills": [
            # A genuine homing shot (see "homing_bolt" in core/motions.py) —
            # always finds its living target regardless of drift.
            Ability("Spirit Lance", "skill", "homing_bolt", 2, 0.6, tag="spirit_lance"),
            ...
            Ability("Doppelganger", "skill", "instant", 4, 0.0, tag="doppelganger"),
            # No damage — a short, sharp move-speed burst (the generic
            # "move_speed_up" status).
            Ability("Phantom Rush", "skill", "cast", 5, 0.0, tag="phantom_rush", cast_target="self"),
        ],
        ...
        "ultimate": Ability("Juxtapose", "ultimate", "cast", 6, 0.0, big=True, tag="juxtapose",
                             cast_target="self"),
    }
